...
// ✅ Updated COLLECTION_TYPES - Personal, Employees, Other
          ...
          <View style={styles.typeRow}>
            {COLLECTION_TYPES.map(item => (
              <Button 
                key={item.value} 
                title={item.label} 
                variant={item.value === type ? 'primary' : 'outline'} 
...
const styles = StyleSheet.create({
  ...
  backIcon: {fontSize: 36, color: '#1A1A1A'}, 
  headerCenter: {flex: 1, alignItems: 'center'}, 
  headerRight: {width: 42}, 
  headerTitle: {fontSize: 18, fontWeight: '900', color: '#1A1A1A'}, 
  headerSubtitle: {fontSize: 11, color: '#6B7280', marginTop: 3},
  content: {padding: 20, paddingBottom: 40}, 
  label: {fontSize: 11, fontWeight: '800', color: '#4B5563', marginBottom: 7, marginTop: 12}, 
  input: {minHeight: 50, borderWidth: 1, borderColor: '#D9DEE5', borderRadius: 10, backgroundColor: '#FFFFFF', paddingHorizontal: 14, color: '#1A1A1A', fontSize: 14}, 
  inputError: {borderColor: '#B42318'}, 
  errorText: {color: '#B42318', fontSize: 12, marginTop: 5}, 
  typeRow: {flexDirection: 'row', gap: 6, marginBottom: 4}, 
  typeButton: {flex: 1, paddingVertical: 11, borderRadius: 8, backgroundColor: '#E9EDF1', alignItems: 'center'}, 
  typeButtonActive: {backgroundColor: '#E4002B'}, 
  typeText: {fontSize: 11, color: '#52606D', fontWeight: '800'}, 
  typeTextActive: {fontSize: 11, color: '#FFFFFF', fontWeight: '800'}, 
  sectionTitle: {fontSize: 11, fontWeight: '900', letterSpacing: 1, color: '#6B7280', marginTop: 26, marginBottom: 8}, 
  userForm: {backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#E1E5EA'}, 
  userHeading: {flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4}, 
  userTitle: {fontSize: 16, fontWeight: '900', color: '#1A1A1A'}, 
  removeText: {color: '#B42318', fontSize: 12, fontWeight: '800'}, 
  field: {marginTop: 4}, 
  addButton: {borderWidth: 1, borderColor: '#E4002B', borderRadius: 10, minHeight: 48, justifyContent: 'center', alignItems: 'center', marginTop: 4}, 
  addButtonText: {color: '#E4002B', fontWeight: '900'}, 
  saveButton: {backgroundColor: '#E4002B', borderRadius: 10, minHeight: 52, justifyContent: 'center', alignItems: 'center', marginTop: 14}, 
  saveText: {color: '#FFFFFF', fontWeight: '900'}, 
  cancelButton: {minHeight: 48, justifyContent: 'center', alignItems: 'center', marginTop: 4}, 
