// AudioPlayer.js - TrackPlayer Version (Working)
...
const setupTrackPlayer = async () => {
  try {
    ...
    // TrackPlayer already setup — safe to ignore
...
const AudioPlayer = ({
  ...
  const handleRetry = async () => {
    ...
    // Trigger reload by re-running the load effect
    setIsSetup(false);
